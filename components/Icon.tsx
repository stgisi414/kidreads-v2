...
type IconProps = {
  name: 'microphone' | 'home' | 'play' | 'star' | 'check' | 'retry' | 'trash' | 'results' | 'login' | 'logout' | 'stories' | 'save' | 'close' | 'book' | 'quiz' | 'phoneme' | 'speaker' | 'idea' | 'bookmark' | 'share' | 'location' | 'report' | 'print';
  className?: string;
};
...
const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  const icons: Record<string, JSX.Element> = {
    ...
    save: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c.133.133.133.348 0 .48l-10.375 10.375a.333.333 0 01-.48 0L3.322 8.36a.333.333 0 010-.48l1.103-1.104a.333.333 0 01.48 0L9 11.08l9.113-9.113a.333.333 0 01.48 0l1.103 1.104z" />
        </svg>
    ),
    close: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    bookmark: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v18l9-6 9 6V3H3z" />
        </svg>
    ),
    share: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
